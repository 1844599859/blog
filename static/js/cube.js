...
(function(){
    ...
    var showPhotos = function(){
        layer.photos({
          photos:'.cube-post-content p,.cube-status-post p',
          anim: 0
        });
    }
    var offcanvas = function(){
        var $clone = $('#cube-menu-wrap').clone();
        $clone.attr({
            'id':'offcanvas-menu'
        });
        $clone.find('> ul').attr({
        ...
        $('#cube-page').prepend($clone);
        $('.js-cube-nav-toggle').on('click',function(){
    ...
    var menu = function(){
        $(document).click(function(e){
            var container = $('#offcanvas-menu,.js-cube-nav-toggle');
        ...
        $('#cube-header-section:not(.color-banner) ul>li').hover(function(){
